...
def review_pr(
    ...
    *,
    ...
    prompt = (
        ...
        f"Read the relevant source files carefully. Grep for callers of changed functions. Check "
        f"error paths, memory lifecycles, concurrency assumptions, and whether tests actually exercise "
        f"the changed behavior. Be thorough — a separate skeptic pass will drop speculative findings, "
        f"so err on the side of flagging what you find.\n\n"
        f"## Output\n"
        ...
        f"A 500-line PR usually needs 3-10 comments. Return at most {max_findings} findings. "
